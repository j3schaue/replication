...
af <- read.xlsx("Data_Raw.xlsx", "Allowed_forbidden")
...
a1 <- read.xlsx("Data_Raw.xlsx", "Anchoring1")
...
a2 <- read.xlsx("Data_Raw.xlsx", "Anchoring2")
...
a3 <- read.xlsx("Data_Raw.xlsx", "Anchoring3")
...
a4 <- read.xlsx("Data_Raw.xlsx", "Anchoring4")
...
fp <- read.xlsx("Data_Raw.xlsx", "Flag Priming")
...
gl <- read.xlsx("Data_Raw.xlsx", "Gain_Loss")
...
gf <- read.xlsx("Data_Raw.xlsx", "Gambler's Fallacy")
...
iat <- read.xlsx("Data_Raw.xlsx", "IAT correlation")
iat<- iat[3:nrow(iat), 1:(ncol(iat) - 3)]
names(iat) = c("Site", "N" ,"NExcluded", "r")
iat["Experiment"] <- "IAT"
iat["es.measurement"] <- "corr"

ic <- read.xlsx("Data_Raw.xlsx", "Imagined Contact")
...
mag <- read.xlsx("Data_Raw.xlsx", "Math_Art Gender")
...
mp <- read.xlsx("Data_Raw.xlsx", "Money Priming")
...
qa <- read.xlsx("Data_Raw.xlsx", "Quote Attribution")
...
r <- read.xlsx("Data_Raw.xlsx", "Reciprocity")
...
af <- mutate(.data = af,
             oddsratio = (NAllowNo*NForbidNo)/(NAllowYes*NForbidYes), #Odds ratio
...
#Writing CSV file
write.csv(df,  "Data_Clean.csv", row.names=F)
