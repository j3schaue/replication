...
###------------------------------------------------------------###
###------------------------------------------------------------###
### ANALYSES OF RAND (RRR) REPLICATIONS
###------------------------------------------------------------###
###------------------------------------------------------------###
###------------------------------------------------------------###
...
runComparisonAnalyses(data=df, t='d', v='vd', ratios=ratios, paper='rand', methods=methods)

###------------------------------------------------------------###
###------------------------------------------------------------###
### RRR-rand Heterogenetiy Q-Test
###------------------------------------------------------------###
###------------------------------------------------------------###
...
fetab
write.csv(fetab, "./results/qtest_fixed_rrr-rand_include.csv", row.names=F)
...
fetab
write.csv(fetab, "./results/qtest_fixed_rrr-rand_exclude.csv", row.names=F)


###------------------------------------------------------------###
###------------------------------------------------------------###
### RRR-rand variance components
###------------------------------------------------------------###
###------------------------------------------------------------###
...
for(mm in methods){# for each method, compute tau^2 for each set of replicates
  ...
  tab$vbar = vbars
  tab$paper = 'rand'
  write.csv(dplyr::select(tab, experiment, tau2=estimate, ci.lb, ci.ub, paper), paste0('./results/rrr-rand_vc_include_', mm,'.csv'), row.names=F)
}
...
for(mm in methods){# for each method, compute tau^2 for each set of replicates
  ...
  tab$vbar = vbars
  tab$paper = 'rand'
  write.csv(dplyr::select(tab, experiment, tau2=estimate, ci.lb, ci.ub, paper), paste0('./results/rrr-rand_vc_exclude_', mm,'.csv'), row.names=F)
}
